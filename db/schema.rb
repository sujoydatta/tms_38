...
ActiveRecord::Schema.define(version: 20151113082314) do
  ...
  add_index "user_subjects", ["courses_id"], name: "index_user_subjects_on_courses_id"
  add_index "user_subjects", ["subjects_id"], name: "index_user_subjects_on_subjects_id"
